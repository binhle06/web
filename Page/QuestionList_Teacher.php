    	...
    	<form method="post" id="question_form">
      		<div class="modal-content">
	        	...
	        	<div class="modal-footer">
	        		...
	        		<input type="hidden" name="teacher" value="Question_list" />
...
$(document).ready(function(){
	...
	var dataTable = $('#course_table').DataTable({
        ...
        "ajax":{
            ...
            type:"POST",
			data:{teacher_action:'fetch', teacher:'Question_list'}
        },
        "columnDefs":[
           {
            "targets":[0,3,4],
	...
	$(document).on('click', '.edit', function(){
		...
		$.ajax({
			url:"../DatabaseConn/Ajax_func.php",
			method:"POST",
			data:{teacher_action:'edit_fetch', question_id:question_id, teacher:'Question_list'},
			dataType:"json",
			success:function(data)
			{
	...
	$('#ok_button').click(function(){
		$.ajax({
			url:"../DatabaseConn/Ajax_func.php",
			method:"POST",
			data:{question_id:question_id, teacher_action:'delete', teacher:'Question_list'},
			dataType:"json",
			success:function(data)
			{
